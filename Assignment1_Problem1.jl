...
# ╔═╡ b769c972-0d55-11f0-0d45-cbb40c417823
using PlutoUI

# ╔═╡ e4037c14-1731-4ffe-92be-9fe0b14c0ca1
using CategoricalArrays

# ╔═╡ add62c49-444f-4629-9f11-bdd41f60e016
using CSV

# ╔═╡ 359e1d52-12fa-49a4-88e0-a3b183cb0177
using DataFrames

# ╔═╡ d4afa6ef-89ed-40d5-9a15-44dac8d5693a
using MLJ

# ╔═╡ 33351438-0e55-4019-8ce9-2976d4b3e25a
using Statistics

# ╔═╡ 88e3c180-498f-4dc1-ac18-f3ed24705257
using AlgebraOfGraphics

# ╔═╡ a14ed804-1af0-479c-af71-066407adad18
using MLJLinearModels

# ╔═╡ c9b7b0e9-149a-4afe-a0ba-c9ebd4b520e3
using MLJBase

# ╔═╡ 349496fd-7a96-4e26-832c-ac457b8f3c4f
PlutoUI.TableOfContents(title="Table of Content",indent=true,depth=4,aside=true)

# ╔═╡ 65263bc8-f873-4408-8531-dc6995f54ef1
md"# Problem 1: Regression Model"

# ╔═╡ 759dfeaa-eb70-4dbd-9af0-711b1b88ac97
md"## 1. Data Exploration"

# ╔═╡ c6921612-ef80-4d41-90a1-a10f59d135aa
# Loading dataset
GFW_df = DataFrame(CSV.File("./dataset/global_food_wastage_dataset.csv",header=1))

# ╔═╡ 4e2ecf9f-5a86-44b0-ae07-33d59a788538
# Checking dataset variables
schema(GFW_df) |> DataFrames.DataFrame

# ╔═╡ 9bab43ec-b8df-493f-b108-12252376f6bd
# Check dataset description
describe(GFW_df)

# ╔═╡ ad6d6f80-c7ef-4f41-b860-ae22fa66b910
# Visualizing years by country in histogram
data(GFW_df) * mapping(:Year,stack=:"Food Category",color=:"Food Category")*histogram(bins=range(2018,2024,30)) |> draw()

# ╔═╡ a456b0ea-a89c-40a9-908f-fa122a757446
# Checking unique values of Year column and getting count
combine(groupby(GFW_df,[:Year]),nrow => :count)

# ╔═╡ 1c70c1d3-c81b-43e0-8820-e82450a1145f
# Creating Linear Regression model object
lnr_leg_model = LinearRegression(fit_intercept=true)

# ╔═╡ 66966c45-5449-42e9-aeff-867dbadeb7c2
md"## 2. Data Preparation"

# ╔═╡ 08fb8f65-50fd-4628-8439-724a7421132a
...
# ╔═╡ 69ae17d1-1c71-40e2-beb3-9bde260e7b0a
# Convert country column into categorical values
GFW_df.Country = categorical(GFW_df.Country)

# ╔═╡ 2116cd85-f709-433c-b896-f5d4e6e6d576
# Convert country column into categorical values
GFW_df.Food_Category = categorical(GFW_df.Food_Category)

# ╔═╡ 4440fcaa-c88b-402d-9e7a-3690ea00ed6c
# Identifying columns for Household Waste(Total waste)
columns_total_waste = [:Country, :Year, :Food_Category, :Population_Million, :Household_Waste_Percent]

# ╔═╡ 0695c423-6562-4ca4-a584-56e4cdddb53b
# Identifying columns for Economic Loss
columns_economic_loss = [:Country, :Year, :Food_Category, :Total_Waste_Tons, :Population_Million, :Household_Waste_Percent]

# ╔═╡ 8c5ef152-9844-407d-8f1f-b3dc8045344d


# ╔═╡ 2dfb5d52-e443-4418-83b5-4e470f16cfa9
# Selecting identified column values: Household Waste(Total Waste)[x,y] 
X_total_waste = GFW_df[:, columns_total_waste]

# ╔═╡ de426fff-75ec-497e-929b-9725f4236bb6
y_total_waste = GFW_df.Total_Waste_Tons

# ╔═╡ d69583ca-f236-469d-aabd-393032442ef1
# Selecting identified column values: Economic Loss[x,y]
X_economic_loss = GFW_df[:, columns_economic_loss]

# ╔═╡ 9eb74f75-100e-4836-b9ed-789a10b16d45
y_economic_loss = GFW_df.Economic_Loss_Million

# ╔═╡ cc49a499-ae6b-40d1-8eec-ef3c82d926ab
md"## 3. Model Development"

# ╔═╡ 3a732a71-5866-479b-8cdf-11c3d483fb3d
# Loading Linear Regression model
@load LinearRegressor pkg=MLJLinearModels verbosity=0

# ╔═╡ c581e969-3eef-44a1-888e-29bddb88969b
# Creating Linear regression model object
linear_model = LinearRegressor()

# ╔═╡ 5af721a9-a9e7-42c0-816e-b4e06e743820
# Creating hot-encoder object
hot_encoder = OneHotEncoder()

# ╔═╡ c7244aca-a81b-4b0f-92f2-5b26ca5ab393
# Hot-encoding model object
piped_model = hot_encoder |> linear_model

# ╔═╡ 332d1437-7151-406d-ba7f-123ce2ee995d
md"## 4. Model Training and Testing"

# ╔═╡ 420325e3-4282-4385-bd43-843703901689
# Training and Testing model: Household waste
mach_total_waste = machine(piped_model, X_total_waste, y_total_waste)

# ╔═╡ 5d0dbca6-0b8c-46ae-b094-7122ece15069
fit!(mach_total_waste)

# ╔═╡ b6acb230-1e49-42ed-8f7f-12cab7f3aea8
y_piped_total_waste = MLJ.predict(mach_total_waste, X_total_waste) |> MLJ.unwrap

# ╔═╡ 4280ad2a-a798-4e06-8ace-fd4c4e9227a7
# Training and Testing model: Economic Loss

# ╔═╡ 6a0f8b60-679a-4771-b985-bbb1c5e7c55f
mach_economic_loss = machine(piped_model, X_economic_loss, y_economic_loss)

# ╔═╡ 3ea43ff0-fe01-4ccc-a940-1f630a81cbfb
fit!(mach_economic_loss)

# ╔═╡ 80e005a5-d18d-4e9a-99b5-bf08a210bf7d
y_piped_economic_loss = MLJ.predict(mach_economic_loss, X_economic_loss) |> MLJ.unwrap

# ╔═╡ 3bff9d7a-8e8e-4b5a-a053-18938c4b8efc
md"## 5. Model Evaluation"

# ╔═╡ fe64ed4f-c17e-40f4-9aae-f5ff01dcdfa3
println("Economic Loss Model Score: ", round(MLJ.rsq(y_piped_total_waste, y_economic_loss), digits=4))

# ╔═╡ eb705d6f-328c-4b6a-b0b8-d5fccafca174
println("Total Waste Model Score: ", round(MLJ.rsq(y_piped_economic_loss, y_total_waste), digits=4))
...
manifest_format = "2.0"
project_hash = "798484534ff96e9366a5543e61df520d2bddaa7f"
